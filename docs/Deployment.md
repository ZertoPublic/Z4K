...
##### Installing Zerto for Kubernetes on a Kubernetes Cluster Option 1
...
##### Installing Zerto for Kubernetes on a Kubernetes Cluster Option 2
...
##### Installing Zerto Kubernetes Manager Proxy on Additional Clusters - Option 1
...
##### Installing Zerto Kubernetes Manager Proxy on Additional Clusters - Option 2    
1. Create the following values.yaml:
   ``` yaml
    global:
      authentication:
...
##### Installing Zerto Kubernetes Manager on a Kubernetes Cluster - Option 1
...
##### Installing Zerto Kubernetes Manager on a Kubernetes Cluster - Option 2 
