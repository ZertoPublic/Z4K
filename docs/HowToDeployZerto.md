...
5.	[How to update Zerto certificate](#how-to-update-zerto-certificate)
...
## How to update Zerto certificate
    
In order to update your Z4K with a new Zerto certificate run the following command with the relevant environment variables:
